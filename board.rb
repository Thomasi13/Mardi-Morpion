...
class Board
  ...
  def to_string2
    ...
    #créer un array avec les 9 BoardCase
  ...
  def play 
    ...
    @entrer = gets.chomp.to_i
          ...
          case @entrer #compare la valeur entré par l'utilisateur à ces différents cas
        ...
        to_string2 #lance la methode to_string2
